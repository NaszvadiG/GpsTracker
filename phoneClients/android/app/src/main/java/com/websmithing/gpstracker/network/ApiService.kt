...
package com.websmithing.gpstracker.network
...
/**
 * Data class for API response from the GPS Tracker server
 */
...
interface ApiService {
     ...
     * @return A Response containing an ApiResponse object with the server's response
     */
    @FormUrlEncoded
    @POST("update")
