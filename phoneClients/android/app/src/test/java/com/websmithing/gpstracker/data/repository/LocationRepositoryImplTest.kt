...
class LocationRepositoryImplTest {
    ...
    fun setUp() {
        ...
        runTest {
            ...
            whenever(apiService.updateLocation(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any()))
    ...
    fun `uploadLocationData returns true on successful API call`() = runTest {
        ...
        // Assert
        assertTrue(success)
        verify(apiService).updateLocation(
    ...
    fun `uploadLocationData returns false on API network error`() = runTest {
        ...
        // Act
        val success = repository.uploadLocationData(location, TEST_USERNAME, TEST_APP_ID, TEST_SESSION_ID, "test")
